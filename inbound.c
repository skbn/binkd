               ...
               enum renamestyletype ren_style)
{
  ...
  /* Skip mtime para arcmail/pkt/tic/req */
  while (stat (fp, &sb) == 0)
  {
    /* For arcmail, pkt, tic and req the filename already encodes routing
     * and sequence info, making it content-unique by name.  On AmigaOS,
